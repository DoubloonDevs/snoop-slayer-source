...
var snooptrain = new Audio('sound/drop_it_like_a_train.mp3');
snooptrain.volume = 0.35;
snooptrain.load();
var gofast = new Audio("sound/gotta_go_fast.mp3");
gofast.volume = 0.35;
gofast.load();
var hit = new Audio("sound/hitmarker.mp3");
hit.volume = 0.25;
hit.load();
var smash = new Audio("sound/glass_smash.mp3");
smash.volume = 0.25;
smash.load();
var mario_up = new Audio("sound/smb_powerup.mp3");
mario_up.volume = 0.3;
mario_up.load();
var combo = new Audio("sound/combo.mp3");
combo.volume = 0.2;
combo.load();
var sad_violin = new Audio("sound/game_over.mp3");
sad_violin.volume = 0.15;
sad_violin.load();
var wow = new Audio("sound/wow.mp3");
wow.volume = 0.15;
wow.load();
var chat = new Audio("sound/alert.mp3");
chat.volume = 0.3;
chat.load();
var weed = new Audio("sound/snoop.mp3");
weed.volume = 0.35;
weed.load();