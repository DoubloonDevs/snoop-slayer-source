  ...
  function processRequest(e) {
    if (xhr.readyState == 4) {
      if (xhr.status >= 200 && xhr.status < 304) {
        ...
        console.log('online!');
        download_data('https://raw.githubusercontent.com/DoubloonDevs/SnoopSlayer/gh-pages/downloads/windows/download.DATA', main_dir + 'download.DATA');
      } else {
        online = false;
        console.log('offline :(');
